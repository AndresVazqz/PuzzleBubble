...
void Sprite::renderAngle(float alpha) const
{
	...
	modelview = glm::translate(modelview, glm::vec3(8.f, 34.f, 0.f));
	modelview = glm::rotate(modelview, alpha, glm::vec3(0.f, 0.f, 1.f));
	modelview = glm::translate(modelview, glm::vec3(-8.f, -34.f, 0.f));
